...
BOTADDLOGS = int(getenv("BOTADDLOGS", "-1002150393522 ")) # LOGGER_ID Id Also Use No Problem
GBAN_LOGS = int(getenv("GBAN_LOGS", "-1002150393522 "))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Dynofed")

...
GBAN_LOGS = int(getenv("GBAN_LOGS", "-1002036001760"))
GCAST_USERS = list(map(int, getenv("GCAST_USERS", "7109918450").split()))
OWNER_ID = int(getenv("OWNER_ID", 7109918450))
OWNER = int(getenv("OWNER", 7109918450))
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/1d3c8060d1d3398dccf60.jpg")
